...
const FooterLogo = () => {
  ...
  return (
    <div className="footer-logo">
      <Link href="/">{logoAbc?.original_url ? <Image src={Logo} height={46} width={234} alt={settingData?.general?.site_name ? settingData?.general?.site_name : "mobile-park-bd-logo"} /> : settingData?.general?.site_name && <h2 className="f-w-600">{settingData?.general?.site_name ? settingData?.general?.site_name.split(" ")[0] : "Logo Here"}</h2>}</Link>
    </div>
  );
};
