...
import { RiDashboardLine, RiShoppingBag3Line, RiListOrdered, RiPriceTag3Line, RiMedalLine, RiUserLine, RiMenuLine, RiCloseLine, RiMenu2Line } from 'react-icons/ri';
...
const navItems = [
  ...
  { href: '/admin/menu', label: 'Menu', icon: RiMenu2Line },
